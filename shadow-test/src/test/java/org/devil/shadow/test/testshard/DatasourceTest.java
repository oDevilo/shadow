...
//
//import org.devil.shadow.test.ApplicationUtil;
...
//@ContextConfiguration(locations = {"classpath:org/devil/shadow/test/testshard/applicationContext-mybatis-datasource.xml"})
...
//    @Transactional
//    public void testTx() {
//        System.out.println(ApplicationUtil.getBeanByType(DatasourceTest.class));
//        test1();
//        update();
//        if (true) {
...
//        ApplicationContext context = new ClassPathXmlApplicationContext("org/devil/shadow/testshard/applicationContext-mybatis-datasource.xml");
//        DatasourceTest test = ApplicationUtil.getBeanByType(DatasourceTest.class);
//        test.testTx();
//    }
//
//}
